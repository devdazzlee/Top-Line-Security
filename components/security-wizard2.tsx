...
export function SecurityWizard2({ modalOpen, setModalOpen }: { modalOpen: boolean, setModalOpen: (open: boolean) => void }) {
                ...
                <div className="flex flex-col items-center">
                    ...
                    <div className="grid grid-cols-2 gap-4 w-full max-w-sm mb-4 ">
                        <div className="col-span-1">
                            ...
                            <Button className="w-full bg-blue-500" onClick={() => handlePropertySelect("house")}>
                                House
                            </Button>
                        </div>
                        <div className="col-span-1">
                            <div className="border-2 border-blue-500 rounded-lg overflow-hidden mb-2">
                                <Image
                                    src="/Images/Steps/Apartment.jpg"
                                    alt="Apartment"
                                    width={150}
                                    height={150}
                                    className="mx-auto object-contain"
